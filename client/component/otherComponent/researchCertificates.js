        ...
        sortedItems.forEach((item) => {
            ...
            content.innerHTML = `
                <div style="width: 80%; margin: 120px auto 0 auto; text-align: center;">
                    ...
                    <div style="font-size: 16px; color: #666; font-style: italic; text-shadow: 1px 1px 2px rgba(255,255,255,0.8); max-width: 90%; margin-left: auto; margin-right: auto; word-wrap: break-word;">
                        ${researchers}
                    </div>
